...
const int VAL_OFFSET_START_POSST_THREATS = 400;
...
static TTF_Font* g_font_text2 = NULL;
...
static char g_name_audio_exp_main[] = {"Explosion+2.wav"};

static char g_name_exp_threats[] = {"exp.png"};
static char g_name_threats[] = {"af1.png"};
static char g_name_bullet_threats[] = {"sphere.png"};
